...
class PersonalService {
  ...
  async getLogDetails({
    ...
    let unreadMsgArr = [];
    if (markSeen === true) {
      unreadMsgArr = await this.#personalLogs.get({
        where: {
          connectionId: connectionId,
          toId: apiUser.id,
          isDeleted: false,
